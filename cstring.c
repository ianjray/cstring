...
/// 2 balances memory usage and reallocation frequency well.
...
struct string {
    ...
    char *buf;
    /// Small string optimization: holds up to 7 chars + NUL inline.
    char sso[8];
};
