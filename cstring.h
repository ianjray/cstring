...
///
/// 3. Other functions that *return non-pointer* return the value directly, and silently accept invalid arguments.
...
///   - EINVAL: String invalid.
int string_clear(struct string *) PUBLIC;
...
/// @param len Number of characters to erase (if the string is shorter, as many characters as possible are erased).
/// @return 0 on success.
/// @return -1 on failure, and errno is set to:
///   - EINVAL: String invalid.
///   - ERANGE: Position invalid.
